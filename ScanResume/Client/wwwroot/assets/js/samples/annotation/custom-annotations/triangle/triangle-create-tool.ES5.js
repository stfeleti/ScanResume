!(function(t) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              K(b !== Function.prototype ? F(y).concat(F(b)) : F(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : T(t, n, r)
        );
      },
      J = function(t, n) {
        m(t);
      ...
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
          return u && X && q(V, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            ...
            O >= w && ((x += h.slice(w, O) + A), (w = O + E.length));
          }
          return x + h.slice(w);
        },
      ];
  ...
  function(t, n) {
    ...
    window.TriangleCreateToolFactory = {
            ...
            (c = [
              {
                key: 'mouseMove',
                value: function(t) {
                  o(f(l.prototype), 'mouseMove', this).call(this, t),
                    this.annotation &&

  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ut = function(t, n) {
          return Wt(t, (n = m(n, !0))) ? h(2, t[n]) : G(t, n);
        },
        Vt = function(t, n, r) {
      ...
      mt || ((V.f = Ut), (U.f = Vt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Ut, defineProperty: Vt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === G && i(V, t) && !i(B, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
      ...
      nt = function(t) {
        for (var n, r = t === G, e = T(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), X(this, t, E(1, r));
            };
            ...
            (c = [
              {
                ...
                value: function(r, e, o) {
                  var i = r.vertices[this.index].x,
                    u = r.vertices[this.index].y,
                    c = t.ControlHandle.handleWidth / o,
                    f = t.ControlHandle.handleHeight / o;
                  return (i -= 0.5 * c), (u -= 0.5 * f), new n.Rect(i, u, i + c, u + f);
                },
              },
              {
                key: 'move',
                value: function(n, r, e) {
                  ...
                  for (var o = Number.MAX_VALUE, i = -Number.MAX_VALUE, u = Number.MAX_VALUE, c = -Number.MAX_VALUE, f = 0; f < n.vertices.length; ++f) {
                    var a = n.vertices[f];
                    (o = Math.min(o, a.x)), (i = Math.max(i, a.x)), (u = Math.min(u, a.y)), (c = Math.max(c, a.y));
                  }
                  var s = new t.Rect(o, u, i, c);
                  return n.setRect(s), !0;
                },
              },
            ]) && e(u.prototype, c),
            f && e(u, f),

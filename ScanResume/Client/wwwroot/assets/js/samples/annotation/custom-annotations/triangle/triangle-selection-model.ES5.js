!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (N(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : b(n, e)) - o));
          },
        },
        kt = function(t, n) {
      ...
      mt || ((G.f = Bt), (B.f = Gt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Bt, defineProperty: Gt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Ut, Dt),
        p(Ut, yt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new K(i) }); s < c; ) O(t, s++);
              })),
              (_ = v.prototype = E(Ut)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var b,
        ...
        j = ('Array' == n && E.entries) || P;
      if (
        (j && (S = s(j.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((O = !0),
        ...
        if (((b = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: M }), g)) for (m in b) m in E || i(E, m, b[m]);
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (b = function(t) {
        ...
        o && (B(b, 'byteLength', '_l'), B(m, 'buffer', '_b'), B(m, 'byteLength', '_l'), B(m, 'byteOffset', '_o')),
        f(m.prototype, {
          getInt8: function(t) {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
      ...
      R = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                M ? O.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = M || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          M ? O.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      C = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = E(r, { enumerable: O(0, !1) }))) : (i(t, C) || T(t, C, O(1, {})), (t[C][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        m(t);
      ...
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, O(1, r));
            };
          return u && q && $(V, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var O = String(m[0]), E = a(s(u(m.index), h.length), 0), P = [], F = 1; F < m.length; F++) P.push(void 0 === (S = m[F]) ? S : String(S));
            var M = m.groups;
            if (p) {
              var j = [O].concat(P, E, h);
              void 0 !== M && j.push(M);
              var A = String(n.apply(void 0, j));
            } else A = y(O, h, E, P, M, n);
            E >= w && ((x += h.slice(w, E) + A), (w = E + O.length));
          }
          return x + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                O = f(b, v ? h : h.slice(x));
              if (null === O || (_ = l(c(b.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
    ...
    (function(t) {
      ...
      var r = (function(t) {
        ...
        return (
          ...
          f(b, 'constructor', v),
          f(v, 'constructor', p),
          (p.displayName = f(v, c, 'GeneratorFunction')),
          (t.isGeneratorFunction = function(t) {
            var n = 'function' == typeof t && t.constructor;
            return !!n && (n === p || 'GeneratorFunction' === (n.displayName || n.name));
          }),
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, v) : ((t.__proto__ = v), f(t, c, 'GeneratorFunction')), (t.prototype = Object.create(b)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
        ...
        initialize: function(n, r) {
          return (function(u) {
            !(function(t, n) {
              ...
              (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && o(t, n);
            })(l, u);
            var c,
              f,
              a,
            ...
            function l(e, o) {
              ...
              if (
                ...
                var u = t.TriangleControlHandleFactory.initialize(n, r),
                  c = i.getControlHandles();
                c.push(new u(e, 0)), c.push(new u(e, 1)), c.push(new u(e, 2));
              }
              return i;
            }
            return (
              ...
              (f = [
                {
                  ...
                  value: function(t, r, e) {
                    (t.lineWidth = void 0 !== e ? n.SelectionModel.selectionOutlineThickness / e : n.SelectionModel.selectionOutlineThickness),
                      this.canModify()
                        ? (t.strokeStyle = n.SelectionModel.defaultSelectionOutlineColor.toString())
                        : (t.strokeStyle = n.SelectionModel.defaultNoPermissionSelectionOutlineColor.toString()),
                      t.beginPath(),

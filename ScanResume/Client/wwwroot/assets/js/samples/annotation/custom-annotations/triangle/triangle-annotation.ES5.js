          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), X(this, t, E(1, r));
            };
    ...
    !(function(t) {
      t.TriangleAnnotationFactory = {
        initialize: function(n, r) {
          var c = (function(c) {
            ...
            function p() {
              ...
              !(function(t, n) {
                ...
                ((e = h.call(this, 'triangle')).Subject = 'Triangle'),
                (e['AnnotType;'] = 'triangle'),
                (e.vertices = []);
              for (var o = 0; o < 3; ++o) e.vertices.push(new r.Point());
              return (e.selectionModel = t.TriangleSelectionModelFactory.initialize(n, r)), e;
            }
            return (
              (a = p),
              (s = [
                ...
                },
                {
                  ...
                  value: function(t) {
                    var n = this.getRect(),
                      r = t.x1 - n.x1,
                      e = t.y1 - n.y1;
                    this.vertices.forEach(function(t) {
                      return t.translate(r, e);
                    }),
                      this.setRect(t);
                  },
                },
                {
                  key: 'serialize',
                  value: function(t, r) {
                    var e = o(f(p.prototype), 'serialize', this).call(this, t, r);
                ...
                },
                {
                  key: 'deserialize',
                  value: function(t, r) {
                    o(f(p.prototype), 'deserialize', this).call(this, t, r), (this.vertices = n.XfdfUtils.deserializePointArray(t.getAttribute('vertices'), r));
                  },
                },
              ]) && e(a.prototype, s),
              l && e(a, l),
          ...
          return (c.SerializationType = n.CustomAnnotation.SerializationTypes.CUSTOM), (c.prototype.elementName = 'triangle'), c;
        },

!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var d, y, g = i(n), m = o(g), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? h(n, S) : a ? h(n, 0) : void 0; S > x; x++)
          if ((p || x in m) && ((y = b((d = m[x]), x, g)), t))
            if (r) w[x] = y;
            else if (y)
              switch (t) {
                case 3:
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Mt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = y(c.length), o = At(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
        ...
        Lt = {
          ...
          filter: function(t) {
            return It(this, X(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Vt = function(t, n, r) {
          return !(Bt(t, (n = b(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? U(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((V.f = Wt), (W.f = Vt)),
      ...
      v(Ut, Dt),
        h(Ut, dt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        Ft(Ut, 'buffer', 'b'),
        Ft(Ut, 'byteOffset', 'o'),
        Ft(Ut, 'byteLength', 'l'),
        Ft(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return St in r ? Tt(v, r) : Mt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
                    if (d % n) throw Y('Wrong length!');
                    if ((u = d - p) < 0) throw Y('Wrong length!');
                  } else if ((u = y(o) * n) + p > d) throw Y('Wrong length!');
                  c = u / n;
            ...
            : (u(function() {
              ...
              J(m !== Function.prototype ? A(d).concat(A(m)) : A(d), function(t) {
                t in v || h(v, t, d[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      var m,
        ...
        A = P || x(d),
        I = d ? (_ ? x('entries') : A) : void 0,
        T = ('Array' == n && O.entries) || P;
      if (
        (T && (S = s(T.call(new t()))) !== Object.prototype && S.next && (f(S, w, !0), e || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? A : x('values'), keys: y ? A : x('keys'), entries: I }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function U(t, n, r, e, o, i) {
      ...
      for (var c = t[T]._b, a = u + t[M], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      M = !!(function() {
        try {
          ...
          return (I || 'function' == typeof PromiseRejectionEvent) && t.then(T) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
      ...
      R = function(t) {
        g.call(a, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                I ? E.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = I || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
    ...
    var o = r(1),
      ...
      H =
        ...
        s(function() {
          ...
          : N,
      $ = function(t) {
        var n = (V[t] = O(R.prototype));
        return (n._k = t), n;
      },
      K =
        Y && 'symbol' == e(R.iterator)
          ? function(t) {
              return 'symbol' == e(t);
            }
          : function(t) {
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = j(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = j(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    Y ||
      (a(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), H(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), P = [], A = 1; A < b.length; A++) P.push(void 0 === (S = b[A]) ? S : String(S));
            var I = b.groups;
            if (h) {
              var T = [E].concat(P, O, p);
              void 0 !== I && T.push(I);
              var F = String(n.apply(void 0, T));
            } else F = d(E, p, O, P, I, n);
            O >= w && ((x += p.slice(w, O) + F), (w = O + E.length));
          }
          return x + p.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < p.length; ) {
              ...
              var _,
                E = a(m, v ? p : p.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : x)), p.length)) === S) x = u(p, x, y);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var y,
        ...
        b = u[g],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, p), S[l] || c(S, l, g), (a[g] = p), m)) for (y in e) S[y] || i(S, y, e[y], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    ...
    !(function(t) {
      ...
      var r,
        ...
        v = 'overlayPanel';
      function d(t) {
        return l[t].instance.Core.documentViewer.getDocument();
      }
      function y(t) {
        return l[t].instance.Core.documentViewer;
      }
      function g() {
        var n = 1,
          r = 1;
        if (t.DiffOverlaySlider.isEnabled()) {
          var e = t.DiffOverlaySlider.getValue();
          (n = 1 - e), (r = e);
        }
        var o = d(h),
          i = y(p).getCurrentPage(),
          u = y(v).getCurrentPage();
        o.setDocumentPageOpacity(0, i, n), o.setDocumentPageOpacity(1, u, r);
      }
      function m(n) {
        var r = d(h),
          e = y(h).getCurrentPage();
        switch (n) {
          case t.NudgeTool.TRANSFORMATION_TYPE.HORIZONTAL_TRANSLATION_INC:
            r.translate('right', 1, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.HORIZONTAL_TRANSLATION_DEC:
            r.translate('left', 1, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.VERTICAL_TRANSLATION_INC:
            r.translate('up', 1, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.VERTICAL_TRANSLATION_DEC:
            r.translate('down', 1, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.ROTATION_INC:
            r.rotate((1 * Math.PI) / 180, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.ROTATION_DEC:
            r.rotate((-1 * Math.PI) / 180, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.SCALE_IN:
            r.scale(0.1, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.SCALE_OUT:
            r.scale(-0.1, e);
        }
      }
      function b(t) {
        var n = 'object' === o(t) ? t.name : t || '',
          r = n.endsWith('docx') || n.endsWith('pptx') || n.endsWith('xlsx');
        if (r && u) return u;
        if (!r && i) return i;
        var e = Core.getDefaultBackendType().then(function(n) {
          return t && r ? Core.initOfficeWorkerTransports(n, {}, void 0) : Core.initPDFWorkerTransports(n, {}, void 0);
        });
        return t && r ? (u = e) : (i = e), e;
      }
      function S(t, n) {
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), y(n).loadDocument(r);
                  case 2:
                  case 'end':
                    return t.stop();
                }
      ...
      function w(t) {
        s.forEach(function(n) {
          var r = y(n.panel);
          r.getCurrentPage() !== t && r.setCurrentPage(t);
        });
      }
      function _(t, n, r, e, o, i) {
        d(h).updatePageWithAlignment(r, e, t, n, i, o);
      }
      function E(e) {
        return new Promise(function(o) {
          var i = document.getElementById(e.panel);
          WebViewer(
            {
              path: '../../../lib',
              css: './nudge-tool.css',
              workerTransportPromise: b(e.pdf),
            ...
            u.UI.syncNamespaces({ PDFNet: n.PDFNet }), samplesSetup(u);
            var c = u.UI,
              a = u.Core.documentViewer,
              p = c.Feature,
              g = c.LayoutMode,
              m = c.FitMode;
            c.disableFeatures([p.Annotations]),
              c.setToolMode('AnnotationEdit'),
              a.addEventListener('documentLoaded', function() {
                c.setLayoutMode(g.Single),
                  c.setFitMode(m.FitWidth),
                  e.panel !== h &&
                    a.getDocument().addEventListener('layersUpdated', function() {
                      var t = y(h);
                      d(h) && (t.refreshAll(), t.updateView());
                    });
                var n = i.querySelector('iframe').contentDocument.querySelector('.DocumentContainer');
                (n.onscroll = function() {
                  var e, o;
                  t.DiffAlignmentTool.isInAlignmentMode() ||
                    ...
                    s.forEach(function(t) {
                      var n = l[t.panel].documentContainer;
                      n && (n.scrollLeft !== e && (n.scrollLeft = e), n.scrollTop !== o && (n.scrollTop = o));
                    }),
                    clearTimeout(r),
                  ...
                  a.addEventListener('zoomUpdated', function(e) {
                    f ||
                      ((f = n),
                      clearTimeout(r),
                      (r = setTimeout(function() {
                      ...
                      t.DiffAlignmentTool.isInAlignmentMode() ||
                        (function(t) {
                          s.forEach(function(n) {
                            var r = l[n.panel].instance;
                            r.UI.getZoomLevel() !== t && r.UI.setZoomLevel(t);
                          });
                        })(e);
                  }),
                  a.addEventListener('rotationUpdated', function(t) {
                    !(function(t) {
                      s.forEach(function(n) {
                        var r = y(n.panel);
                        r.getRotation() !== t && r.setRotation(t);
                      });
                    })(t);
                  }),
                  a.addEventListener('pageNumberUpdated', function(n) {
                    t.DiffAlignmentTool.isInAlignmentMode()
                      ? e.panel !== v &&
                        s.forEach(function(t) {
                          y(t.panel).getCurrentPage() !== n && t.panel !== v && y(t.panel).setCurrentPage(n);
                        })
                      : w(n);
                  }),
                  (l[e.panel].documentContainer = n);
              }),
              s.push(e),
              (l[e.panel] = { instance: u }),
              o();
          });
        });
      }
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), Promise.all([S(p, r), S(v, e)]);
                  case 2:
                    t.DiffAlignmentTool.initializeDiffAlignmentToolHandlers(
                      ...
                      function() {},
                      function() {
                        w(y(h).getCurrentPage());
                      }
                    ),
                      (o = l[p].instance.Core.documentViewer.getDocument()),
                      (i = l[v].instance.Core.documentViewer.getDocument()),
                      (u = [
                        { document: o, Core: l[p].instance.Core },
                        { document: i, Core: l[v].instance.Core },
                      ]),
                      t.CompareDocumentManager.initialize(l[h].instance.Core, u, {
                        resetInitialPageRotations: !0,
                        diffAnnotations: !(-1 !== t.navigator.userAgent.indexOf('MSIE') || t.navigator.appVersion.indexOf('Trident/') > -1),
                      });
                  case 7:
                  case 'end':
                    return n.stop();
      ...
      (c = [{ panel: p }, { panel: h }, { panel: v }]),
          ...
          regeneratorRuntime.mark(function n() {
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), O(''.concat(window.location.href, '../../../samples/files/test_doc_1.pdf'), ''.concat(window.location.href, '../../../samples/files/test_doc_2.pdf'));
                  case 2:
                    t.NudgeTool.initializeNudgeTool(function(t) {
                      m(t);
                    }),
                      (document.getElementById('enable-snap-mode').disabled = !l[p].instance.Core.isFullPDFEnabled() && !l[v].instance.Core.isFullPDFEnabled());
                  case 4:
                  case 'end':
                    return n.stop();
                }
        ...
        Promise.all(c.map(E)).then(function() {
          return l[h].instance.UI.disableElements(['leftPanelButton', 'searchButton', 'searchPanel', 'searchOverlay']), a();
        }),
        (document.getElementById('selectControl').onclick = (function() {
          var t = e(
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        n.preventDefault(),
                        (r = document.getElementById('select1')),
                        (e = r.options[r.selectedIndex].value),
                        (o = document.getElementById('select2')),
                        (i = o.options[o.selectedIndex].value),
                        (t.next = 7),
                        O(window.location.href + e, window.location.href + i)
                      );
                    case 7:
                    case 'end':
                      return t.stop();
            ...
            regeneratorRuntime.mark(function t(n) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (r = document.getElementById('url').value), (e = document.getElementById('url2').value), (t.next = 5), O(r, e);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
        ...
        (document.getElementById('file-picker-form').onsubmit = (function() {
          var t = e(
            regeneratorRuntime.mark(function t(n) {
              var r, e;
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (r = document.forms['file-picker-form'][0].files[0]), (e = document.forms['file-picker-form'][1].files[0]), (t.next = 5), O(r, e);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
        ...
        document.getElementById('enable-opacity-slider').addEventListener('change', function() {
          var n = this.checked;
          (document.getElementById('opacity-slider').disabled = !n), t.DiffOverlaySlider.enable(n);
          var r = document.getElementById('opacity-slider').value;
          t.DiffOverlaySlider.setValue(+r / 100), g();
        }),
        document.getElementById('opacity-slider').addEventListener('change', function() {
          var n = document.getElementById('opacity-slider').value;
          t.DiffOverlaySlider.setValue(+n / 100), g();
        });
    })(window);
  },
]);

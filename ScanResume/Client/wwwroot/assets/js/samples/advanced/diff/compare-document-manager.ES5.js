!(function(t) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = N(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          return u && q && $(U, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    (function(t) {
      ...
      var r = (function(t) {
        ...
        return (
          ...
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, v) : ((t.__proto__ = v), f(t, c, 'GeneratorFunction')), (t.prototype = Object.create(m)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
  ...
  function(t, n) {
    !(function(t) {
      ...
      function r() {
        return -1 !== t.navigator.userAgent.indexOf('MSIE') || t.navigator.appVersion.indexOf('Trident/') > -1;
      }
      var e = {
        initialize: function(r, o, i) {
          (this.documentViewer = r.documentViewer),
            (n.prototype = Object.create(r.BaseDocument.prototype)),
            Object.assign(n.prototype, t.FunctionsToOverride),
            Object.assign(n.prototype, t.PublicAPIsForCompareDocs),
            r.Document.registerDocumentType('compare-docs', n, Object.keys(t.PublicAPIsForCompareDocs)),
            e.loadDocumentsToCompare(o, i);
        },
        loadDocumentsToCompare: function() {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
            n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          if (t.length < 2) throw new Error('2 files are required file comparison');
          if (t.length > 2) throw new Error('comparing more than 2 files is not supported for now');
          if (n && n.diffAnnotations) {
            if (r()) throw new Error('diffing annotations is not supported in IE11');
            if (
              t.some(function(t) {
                return !t.Core;
              })
          ...
          return this.documentViewer.loadAsync({ filesToCompare: t, options: n }, { type: 'compare-docs' });
        },
      };
      t.CompareDocumentManager = e;
    })(window);
  },
]);

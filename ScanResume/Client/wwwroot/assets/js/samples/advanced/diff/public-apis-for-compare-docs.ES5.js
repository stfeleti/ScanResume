!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var g, y, d = i(n), m = o(d), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? p(n, S) : a ? p(n, 0) : void 0; S > x; x++)
          if ((h || x in m) && ((y = b((g = m[x]), x, d)), t))
            if (r) w[x] = y;
            else if (y)
              switch (t) {
                case 3:
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ft = function(t, n) {
          if (!w(t) || !(dt in t)) throw X('It is not a typed array constructor!');
          return new t(n);
        },
        Tt = function(t, n) {
        ...
        It = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = y(c.length), o = Ft(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
        ...
        Lt = {
          ...
          filter: function(t) {
            return Tt(this, H(Ot(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Wt = function(t, n) {
          return Ut(t, (n = b(n, !0))) ? h(2, t[n]) : G(t, n);
        },
        Vt = function(t, n, r) {
          return !(Ut(t, (n = b(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? B(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((V.f = Wt), (W.f = Vt)),
      ...
      v(Bt, Ct),
        p(Bt, gt, Ct.values),
        v(Bt, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        At(Bt, 'buffer', 'b'),
        At(Bt, 'byteOffset', 'o'),
        At(Bt, 'byteLength', 'l'),
        At(Bt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return St in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Et(e, n));
                  var g = r.byteLength;
                  if (void 0 === o) {
                    if (g % n) throw z('Wrong length!');
                    if ((u = g - h) < 0) throw z('Wrong length!');
                  } else if ((u = y(o) * n) + h > g) throw z('Wrong length!');
                  c = u / n;
                } else (c = d(r)), (i = new $((u = c * n)));
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new K(i) }); s < c; ) P(t, s++);
              })),
              (_ = v.prototype = E(Bt)),
              p(_, 'constructor', v))
            : (u(function() {
      ...
      if (!p || !v || ('replace' === t && !s) || ('split' === t && !l)) {
        var g = /./[h],
          y = r(u, h, ''[t], function(t, n, r, e, o) {
            return n.exec === a ? (p && !o ? { done: !0, value: g.call(n, r, e) } : { done: !0, value: t.call(r, n, e) }) : { done: !1 };
          }),
          d = y[0],
          m = y[1];
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, g, y, d) {
      ...
      return p(b, t), (w[t] = b), o(o.G + o.W + o.F * (b != m), w), d || g.setStrong(b, t, y), b;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, g, y, d) {
      ...
      var m,
        ...
        F = O || x(g),
        T = g ? (_ ? x('entries') : F) : void 0,
        M = ('Array' == n && E.entries) || O;
      if (
        (M && (S = s(M.call(new t()))) !== Object.prototype && S.next && (f(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          O &&
          'values' !== O.name &&
          ((P = !0),
        ...
        if (((m = { values: _ ? F : x('values'), keys: y ? F : x('keys'), entries: T }), d)) for (b in m) b in E || i(E, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function B(t, n, r, e, o, i) {
      ...
      for (var c = t[M]._b, a = u + t[I], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = c(t), f = arguments.length, s = 1, l = i.f, h = u.f; f > s; )
              for (var p, v = a(arguments[s++]), g = l ? o(v).concat(l(v)) : o(v), y = g.length, d = 0; y > d; ) (p = g[d++]), (e && !h.call(v, p)) || (r[p] = v[p]);
            return r;
          }
        : f;
  },
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (T || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== O.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
      ...
      R = function(t) {
        d.call(a, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                T ? P.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = T || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        d.call(a, function() {
          var n;
          T ? P.emit('rejectionHandled', t) : (n = a.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      D = function(t) {
        var n = this;
    ...
    t.exports = {
      getConstructor: function(t, n, r, f) {
        var s = t(function(t, e) {
          c(t, s, n, '_i'), (t._t = n), (t._i = o(null)), (t._f = void 0), (t._l = void 0), (t[g] = 0), null != e && a(e, r, t[f], t);
        });
        return (
          i(s.prototype, {
            clear: function() {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: P(0, !1) }))) : (i(t, D) || N(t, D, P(1, {})), (t[D][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(V, t) && !i(B, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(V, n) || i(B, n))) {
          var r = I(t, n);
          return !r || !i(V, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = j(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = j(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(B, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, P(1, r));
            };
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            m = s(h);
          if ((y && (g = e(g, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && c(m)))) for (r = new p((n = a(h.length))); n > d; d++) f(r, d, y ? g(h[d], d) : h[d]);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var P = String(b[0]), E = f(s(u(b.index), h.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (S = b[F]) ? S : String(S));
            var T = b.groups;
            if (p) {
              var M = [P].concat(O, E, h);
              void 0 !== T && M.push(T);
              var A = String(n.apply(void 0, M));
            } else A = g(P, h, E, O, T, n);
            E >= w && ((x += h.slice(w, E) + A), (w = E + P.length));
          }
          return x + h.slice(w);
        },
      ];
          ...
          'c' == 'abbc'.split(/(b)*/)[1] || 4 != 'test'.split(/(?:)/, -1)[p] || 2 != 'ab'.split(/(?:ab)*/)[p] || 4 != '.'.split(/(.?)(.?)/)[p] || '.'.split(/()()/)[p] > 1 || ''.split(/.?/)[p]
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = f.call(g, o)) && !((u = g.lastIndex) > l && (a.push(o.slice(l, i.index)), i[p] > 1 && i.index < o[p] && h.apply(a, i.slice(1)), (c = i[0][p]), (l = u), a[p] >= v));

                )
                  g.lastIndex === i.index && g.lastIndex++;
                return l === o[p] ? (!c && g.test('')) || a.push('') : a.push(o.slice(l)), a[p] > v ? a.slice(0, v) : a;
              }
            : '0'.split(void 0, 0)[p]
            ? function(t, n) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                P = a(m, v ? h : h.slice(x));
              if (null === P || (_ = l(c(m.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, y);
              else {
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, a, f, s, l, h, p) {
      for (var v, g, y = s, d = 0, m = !!h && u(h, p, 3); d < f; ) {
        if (d in a) {
          if (((v = m ? m(a[d], d, r) : a[d]), (g = !1), o(v) && (g = void 0 !== (g = v[c]) ? !!g : e(v)), g && l > 0)) y = t(n, r, v, i(v.length), y, l - 1) - 1;
          else {
  ...
  function(t, n, r) {
    for (
      ...
      var y,
        ...
        b = u[d],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, d), (a[d] = h), m)) for (y in e) S[y] || i(S, y, e[y], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        return (
          ...
          b(S.prototype),
          a(S.prototype, u, function() {
            return this;
          }),
          (t.AsyncIterator = S),
          (t.async = function(n, r, e, o, i) {
            void 0 === i && (i = Promise);
            var u = new S(f(n, r, e, o), i);
  ...
  function(t, n) {
    ...
    !(function(t) {
      var n,
        e = (r((n = {}), 'right', 1), r(n, 'left', 2), r(n, 'down', 3), r(n, 'up', 4), n),
        o = {
          updatePageWithAlignment: function(n, r, e, o, i, u) {
            if (
              (function(n, r, e) {
                var o = n[t.DOCUMENT_TO_TRANSFORM_INDEX].document.getPages(),
                  i = n[t.BASE_DOCUMENT_INDEX].document.getPages(),
                  u = r - 1;
                if (!i[e - 1]) return console.error('page number '.concat(e, ' does not exist for ').concat(n[t.BASE_DOCUMENT_INDEX].document.getFilename())), !1;
                if (!o[u]) return console.error('page number '.concat(r, ' does not exist for ').concat(n[t.DOCUMENT_TO_TRANSFORM_INDEX].document.getFilename())), !1;
                return !0;
              })(this.filesToCompare, i, u)
            ) {
              var c = u - 1,
                a = i - 1;
              this.sourcePageIndexToAlignForTarget[c] = a;
              var f = this.filesToCompare[t.DOCUMENT_TO_TRANSFORM_INDEX].document.getPages(),
                s = this.filesToCompare[t.BASE_DOCUMENT_INDEX].document.getPages()[c],
                l = f[a],
                h = n,
                p = r,
                v = e,
                g = o;
              this.shouldResetInitialPageRotations() &&
                ((h = t.normalizePointToZeroRotationSpace(n, t.Util.convertToWebViewerRotationEnum(l.rotation), l.width, l.height)),
                (p = t.normalizePointToZeroRotationSpace(r, t.Util.convertToWebViewerRotationEnum(l.rotation), l.width, l.height)),
                (v = t.normalizePointToZeroRotationSpace(e, t.Util.convertToWebViewerRotationEnum(s.rotation), s.width, s.height)),
                (g = t.normalizePointToZeroRotationSpace(o, t.Util.convertToWebViewerRotationEnum(s.rotation), s.width, s.height)));
              var y,
                d,
                m,
                b,
                ...
                w =
                  ...
                  (m = v),
                  (b = g),
                  (S = t.Alignment.createMatrixForLineAlignment(y, d, m, b)),
                  { horizontalTranslation: (x = t.Util.decomposeMatrix(S)).translateX, verticalTranslation: x.translateY, scaling: x.scaleX, rotation: x.rotation });
              this.alignmentPageStates.setTransformationStateForPageNumber(u, w),
                this.nudgePageStates.setTransformationStateForPageNumber(u, t.DEFAULT_NUDGE_STATE),
                this.updatePageSizeFromTransformationState(i, u, this.shouldResetInitialPageRotations() ? 0 : this.getPage(u).rotation);
            }
          },
          translate: function(t, n, r) {
            if (e[t]) {
              var o = this.nudgePageStates.getTransformationStateForPageNumber(r);
              switch (t) {
                case 'up':
                  o.verticalTranslation -= n;
                  break;
                case 'down':
                  o.verticalTranslation += n;
                  break;
                case 'left':
                  o.horizontalTranslation -= n;
                  break;
                case 'right':
                  o.horizontalTranslation += n;
              }
              this.nudgePageStates.setTransformationStateForPageNumber(r, o);
              var i = this.getSourcePageNumberForAlignedPage(r);
              this.updatePageSizeFromTransformationState(i, r, this.shouldResetInitialPageRotations() ? 0 : this.getPage(r).rotation);
            } else console.error('Please pass in a valid direction: '.concat(Object.keys(e).join(',')));
          },
          scale: function(t, n) {
            var r = this.nudgePageStates.getTransformationStateForPageNumber(n);
            (r.scaling += t), this.nudgePageStates.setTransformationStateForPageNumber(n, r);
            var e = this.getSourcePageNumberForAlignedPage(n);
            this.updatePageSizeFromTransformationState(e, n, this.shouldResetInitialPageRotations() ? 0 : this.getPage(n).rotation);
          },
          rotate: function(t, n) {
            var r = this.nudgePageStates.getTransformationStateForPageNumber(n);
            (r.rotation += t), (r.rotation = r.rotation % (2 * Math.PI)), this.nudgePageStates.setTransformationStateForPageNumber(n, r);
            var e = this.getSourcePageNumberForAlignedPage(n);
            this.updatePageSizeFromTransformationState(e, n, this.shouldResetInitialPageRotations() ? 0 : this.getPage(n).rotation);
          },
          resetNudgedState: function(n) {
            this.nudgePageStates.setTransformationStateForPageNumber(n, t.DEFAULT_NUDGE_STATE),
              this.updatePageSizeFromTransformationState(n, n, this.shouldResetInitialPageRotations() ? 0 : this.getPage(n).rotation);
          },
          resetAlignmentState: function(n) {
            this.alignmentPageStates.setTransformationStateForPageNumber(n, t.DEFAULT_TRANSFORM_STATE),
              this.updatePageSizeFromTransformationState(n, n, this.shouldResetInitialPageRotations() ? 0 : this.getPage(n).rotation);
          },
          setDocumentPageOpacity: function(t, n, r) {
            this.filesToCompare[t] &&
              n <= this.filesToCompare[t].document.getPageCount() &&
              (this.filesToCompare[t].pageOpacities || (this.filesToCompare[t].pageOpacities = []),
              (this.filesToCompare[t].pageOpacities[n - 1] = r),
              this.updatePageSizeFromTransformationState(n, n, this.shouldResetInitialPageRotations() ? 0 : this.getPage(n).rotation));
          },
          shouldDiff: function(t) {
            this.options || (this.options = {}), (this.options.shouldDiff = t), this.updatePageSizeFromTransformationState(1, 1, this.shouldResetInitialPageRotations() ? 0 : this.getPage(1).rotation);
          },
          getOptions: function() {
            return this.options;
          },
        };
      t.PublicAPIsForCompareDocs = o;
    })(window);
  },
]);

!(function(t) {
    ...
    var e = r(1),
      ...
      c = function t(n, r, c) {
        var f,
          ...
          g = n & t.P,
          d = n & t.B,
          y = v ? e : n & t.S ? e[r] || (e[r] = {}) : (e[r] || {}).prototype,
          m = v ? o : o[r] || (o[r] = {}),
          b = m.prototype || (m.prototype = {});
        for (f in (v && (c = r), c))
          (l = ((s = !p && y && void 0 !== y[f]) ? y : c)[f]),
            (h = d && s ? a(l, e) : g && 'function' == typeof l ? a(Function.call, l) : l),
            y && u(y, f, l, n & t.U),
            m[f] != l && i(m, f, h),
            g && b[f] != l && (b[f] = l);
      };
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, a, v) {
        for (var g, d, y = i(n), m = o(y), b = e(a, v, 3), x = u(m.length), w = 0, S = r ? p(n, x) : c ? p(n, 0) : void 0; x > w; w++)
          if ((h || w in m) && ((d = b((g = m[w]), w, y)), t))
            if (r) S[w] = d;
            else if (d)
              switch (t) {
                case 3:
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ot = function(t, n) {
          if (!S(t) || !(yt in t)) throw Y('It is not a typed array constructor!');
          return new t(n);
        },
        Tt = function(t, n) {
        ...
        It = function(t) {
          ...
          for (l && c > 2 && (f = s(f, arguments[2], 2)), n = 0, r = d(a.length), o = Ot(this, r); r > n; n++) o[n] = l ? f(a[n], n) : a[n];
          return o;
        },
        Nt = function() {
        ...
        jt = function() {
          return vt.apply(Rt ? ht.call(Mt(this)) : Mt(this), arguments);
        },
        Ct = {
          copyWithin: function(t, n) {
            return U.call(Mt(this), t, n, arguments.length > 2 ? arguments[2] : void 0);
          },
          every: function(t) {
          ...
          filter: function(t) {
            return Tt(this, K(Mt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Dt = function(t, n) {
          return Tt(this, ht.call(Mt(this), t, n));
        },
        Lt = function(t) {
          Mt(this);
        ...
        Wt = function(t, n) {
          return Ut(t, (n = b(n, !0))) ? h(2, t[n]) : X(t, n);
        },
        Bt = function(t, n, r) {
      ...
      v(Vt, kt),
        p(Vt, gt, kt.values),
        v(Vt, { slice: Dt, set: Lt, constructor: function() {}, toString: pt, toLocaleString: jt }),
        At(Vt, 'buffer', 'b'),
        At(Vt, 'byteOffset', 'o'),
        At(Vt, 'byteLength', 'l'),
        At(Vt, 'length', 'e'),
        ...
        (t.exports = function(t, n, r, e) {
          ...
          b
            ...
            : (u(function() {
              ...
              q(m !== Function.prototype ? O(g).concat(O(m)) : O(g), function(t) {
                t in v || p(v, t, g[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      if (i(y)) {
        for (p = a(t.length); p > b; b++) if ((d = n ? m(u((v = t[b]))[0], v[1]) : m(t[b])) === f || d === s) return d;
      } else for (g = y.call(t); !(v = g.next()).done; ) if ((d = o(g, m, v.value, n)) === f || d === s) return d;
    }).BREAK = f),
      (n.RETURN = s);
  },
  function(t, n, r) {
      ...
      if (
        ...
        O ||
          (((b = n(function(n, r) {
            f(n, b, t);
            var e = v(new m(), n, b);
            return null != r && c(r, d, e[x], e), e;
          })).prototype = w),
          (w.constructor = b)),
          (M || T) && (_('delete'), _('has'), d && _('get')),
          (T || E) && _(x),
          y && w.clear && delete w.clear;
      } else (b = g.getConstructor(n, t, d, x)), u(b.prototype, r), (a.NEED = !0);
      return p(b, t), (S[t] = b), o(o.G + o.W + o.F * (b != m), S), y || g.setStrong(b, t, d), b;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, g, d, y) {
      ...
      var m,
        ...
        P = !1,
        E = t.prototype,
        M = E[l] || E['@@iterator'] || (g && E[g]),
        O = M || w(g),
        T = g ? (_ ? w('entries') : O) : void 0,
        F = ('Array' == n && E.entries) || M;
      if (
        ...
        if (((m = { values: _ ? O : w('values'), keys: d ? O : w('keys'), entries: T }), y)) for (b in m) b in E || i(E, b, m[b]);
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = a(t), f = arguments.length, s = 1, l = i.f, h = u.f; f > s; )
              for (var p, v = c(arguments[s++]), g = l ? o(v).concat(l(v)) : o(v), d = g.length, y = 0; d > y; ) (p = g[y++]), (e && !h.call(v, p)) || (r[p] = v[p]);
            return r;
          }
        : f;
  },
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (T || 'function' == typeof PromiseRejectionEvent) && t.then(F) instanceof n && 0 !== M.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
    ...
    I ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = f(k, t, 1)), (this.reject = f(L, t, 1));
      }),
      (b.f = A = function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      H =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(X, n);
              e && delete X[n], N(t, n, r), e && t !== X && N(X, n, e);
            }
          : N,
      Z = function(t) {
      ...
      q = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (r = E(r, { enumerable: P(0, !1) }))) : (i(t, L) || N(t, L, P(1, {})), (t[L][n] = !0)), H(t, n, r)) : N(t, n, r)
        );
      },
      K = function(t, n) {
        b(t);
        for (var r, e = y((n = S(n))), o = 0, i = e.length; i > o; ) q(t, (r = e[o++]), n[r]);
        return t;
      },
      J = function(t) {
        var n = U.call(this, (t = _(t, !0)));
        return !(this === X && i(B, t) && !i(V, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, L) && this[L][t])) || n);
      },
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== X || !i(B, n) || i(V, n))) {
          var r = I(t, n);
          return !r || !i(B, n) || (i(t, L) && t[L][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = R(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == L || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === X, e = R(r ? V : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(X, n)) || o.push(B[n]);
        return o;
      };
    G ||
      (c(
        (j = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === X && n.call(V, r), i(this, L) && i(this[L], t) && (this[L][t] = !1), H(this, t, P(1, r));
            };
          return u && z && H(X, t, { configurable: !0, set: n }), Z(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = J),
      (T.f = nt),
      u && !r(30) && c(X, 'propertyIsEnumerable', J, !0),
      (g.f = function(t) {
        return Z(v(t));
      })),
    ...
    a(a.S + a.F * ut, 'Object', {
      ...
      j.prototype[k] || r(14)(j.prototype, k, j.prototype.valueOf),
      h(j, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
    ...
    e(
      ...
      'Number',
      {
        toFixed: function(t) {
          ...
          return (d = f > 0 ? g + ((a = d.length) <= f ? '0.' + u.call('0', f - a) + d : d.slice(0, a - f) + '.' + d.slice(a - f)) : g + d);
        },
      }
    );
  },
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            y = 0,
            m = s(h);
          if ((d && (g = e(g, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && a(m)))) for (r = new p((n = c(h.length))); n > y; y++) f(r, y, d ? g(h[y], y) : h[y]);
          else for (l = m.call(h), r = new p(); !(o = l.next()).done; y++) f(r, y, d ? u(l, g, [o.value, y], !0) : o.value);
          return (r.length = y), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, w = '', S = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var P = String(b[0]), E = f(s(u(b.index), h.length), 0), M = [], O = 1; O < b.length; O++) M.push(void 0 === (x = b[O]) ? x : String(x));
            var T = b.groups;
            if (p) {
              var F = [P].concat(M, E, h);
              void 0 !== T && F.push(T);
              var A = String(n.apply(void 0, F));
            } else A = g(P, h, E, M, T, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, w = 0, S = []; w < h.length; ) {
              ...
              var _,
                P = c(m, v ? h : h.slice(w));
              if (null === P || (_ = l(a(m.lastIndex + (v ? 0 : w)), h.length)) === x) w = u(h, w, d);
              else {
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, c, f, s, l, h, p) {
      for (var v, g, d = s, y = 0, m = !!h && u(h, p, 3); y < f; ) {
        if (y in c) {
          if (((v = m ? m(c[y], y, r) : c[y]), (g = !1), o(v) && (g = void 0 !== (g = v[a]) ? !!g : e(v)), g && l > 0)) d = t(n, r, v, i(v.length), d, l - 1) - 1;
          else {
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[y],
        x = b && b.prototype;
      if (x && (x[s] || a(x, s, h), x[l] || a(x, l, y), (c[y] = h), m)) for (d in e) x[d] || i(x, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    ...
    function o(t, n) {
      if (t) {
        ...
        return (
          ...
          'Map' === r || 'Set' === r ? Array.from(t) : 'Arguments' === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? i(t, n) : void 0
        );
      }
    }
    function i(t, n) {
    ...
    !(function(t) {
        ...
        c = {
                    ...
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          ...
                          (o = regeneratorRuntime.mark(function n(r) {
                            var o, i, a, c, f;
          ...
          loadCanvasAsync: function(n) {
            var r,
              ...
              m = d.zoom,
              b = d.pageRotation,
              x = d.drawProgressiveFunction,
              w = this.getPageTransformationMatrix(o),
              S = v,
              _ = this.constructRenderSettingsForDocuments(o, m, 0, S, [t.Core.Math.Matrix.Identity, w]),
              P = (function(t, n, r, e) {
                ...
                return t.map(function(t, i) {
                  if (n[i]) {
                    var u = n[i],
                      ...
                      f = u.zoom,
                      s = u.renderRect;
                    return a > t.getPageCount() || (r && !n[i].renderRect) ? o : h(t, a, c, f, s, e[i]);
                  }
                  return o;
                });
              })(this.getDocumentsToCompare(), _, S, this.dummyAnnotManagers);
            return (
              (i[g] = P.map(function(t) {
                return t.cancel;
              })),
              Promise.all(
                P.map(function(t) {
                          ...
                          switch ((n.prev = n.next)) {
                            case 0:
                              (u = t.Core.getCanvasMultiplier()),
                                (a = p(r, u)),
                                (s = e.getDocumentsToCompare()),
                                (l = Object.keys(_).map(function(t) {
                                  return _[t].pageNumberToRender;
                                })),
                                (h = Object.keys(_).map(function(t) {
                                  return _[t].transformationMatrixToApply;
                                })),
                                (v = f(s, l, h)),
                                (d = new Core.Math.TransformationBuilder().scale(m * u).getFinalTransform()),
                                (w = _.map(function(t) {
                                  return t.renderRect;
                                })),
                                (P = y(a, v, S, w, h, d)),
                                (E = e.getDocumentsToCompareOpacities(o)),
                                1,
                                (M = P.map(function(n) {
                                  ...
                                  var r,
                                    e,
                                    o = window.Core.getPageMatrix(1, b, { width: n.width, height: n.height }, 0, !0, 1);
                                  (o = { a: o.m_a, b: o.m_b, c: o.m_c, d: o.m_d, e: o.m_h, f: o.m_v }), 1 === b || 3 === b ? ((r = n.height), (e = n.width)) : ((r = n.width), (e = n.height));
                                ...
                                (O = t.CanvasHelper.combinePixels(
                                  M[t.DOCUMENT_TO_TRANSFORM_INDEX],
                                  M[t.BASE_DOCUMENT_INDEX],
                                  E[t.DOCUMENT_TO_TRANSFORM_INDEX],
                                  E[t.BASE_DOCUMENT_INDEX],
                                  u,
                                  e.isDiffing()
                                )),
                                x(O),
                        ...
                        case 0:
                          ...
                          for (u = Math.max(a.getPageCount(), c.getPageCount()), f = 1; f <= u; f++)
                            (h = a.getPageInfo(f)),
                              ...
                              h && p
                                ? ((d = Math.max(h.width, p.width)), (y = Math.max(h.height, p.height)), (g = a.getPages()[f - 1]), ((v = l(f, g)).width = d), (v.height = y))
                                : h
                                ? ((g = a.getPages()[f - 1]), (v = l(f, g)))
                                : ((g = c.getPages()[f - 1]), (v = l(f, g))),
                              this.addPage(v);
                                      ...
                                      return regeneratorRuntime.wrap(function(t) {
                                        for (;;)
                                          switch ((t.prev = t.next)) {
                                            case 0:
                                              return (
                                                (e = new m.filesToCompare[r].Core.DocumentViewer()).setViewerElement(document.createElement('div')),
          ...
          constructRenderSettingsForDocuments: function(n, r, e, o, i) {
            var u = this.getSourcePageNumberForAlignedPage(n),
              ...
              s = [
                { pageNumberToRender: n, pageRotation: e, zoom: r * c[t.BASE_DOCUMENT_INDEX], transformationMatrixToApply: i[t.BASE_DOCUMENT_INDEX], renderRect: null },
                { pageNumberToRender: u, pageRotation: e, zoom: r * c[t.DOCUMENT_TO_TRANSFORM_INDEX], transformationMatrixToApply: i[t.DOCUMENT_TO_TRANSFORM_INDEX], renderRect: null },
              ],
              l =
                (function(t, n, r, e) {
                  if (!t) return;
                  for (var o = f(n, r, e), i = [], u = d(t), a = 0; a < n.length; a++) {
                    var c = n[a],
                      ...
                      g = v(h, p, e[a]),
                      y = m(o, u, g, e[a]);
                    y && (y = { width: (b = y).width, height: b.height, x1: b.minX, y1: b.minY, x2: b.maxX, y2: b.maxY, rect: [b.minX, b.minY, b.maxX, b.maxY] }), i.push(y);
                  }
                  var b;
                  return i;
                })(
      ...
      function h(n, e, o, i, u, c) {
        var f;
        return {
          promise: new Promise(function(l, h) {
            try {
              var p = u ? a(a({}, u), {}, { rect: r(u.rect) }) : void 0;
              f = n.loadCanvasAsync({
                pageNumber: e,
                pageRotation: o,
                zoom: i,
                        ...
                        for (;;)
                          switch ((r.prev = r.next)) {
                            case 0:
                              ...
                              return (
                                (u = o.getContext('2d')),
                                (a = t.Util.convertToWebViewerRotationEnum(n.getPageRotation(e))),
                                (f = n.getPageInfo(e)),
                                p
                                  ? ((s = f.width),
                                    (h = f.height),
                                    (1 !== a && 3 !== a) || ((s = f.height), (h = f.width)),
                                    (v = window.Core.getPageMatrix(1, a, { width: s, height: h }, null, !1).inverse()),
                                    (g = window.Core.normalizeRect(v.mult({ x: p.x1, y: p.y1 }), v.mult({ x: p.x2, y: p.y2 }))),
                                    (v = window.Core.getPageMatrix(i, (a || 0) % 4, g, null, !0, window.utils.getCanvasMultiplier())),
                                    u.setTransform(v.m_a, v.m_b, v.m_c, v.m_d, v.m_h, v.m_v))
                                  : c.setAnnotationCanvasTransform(u, i, t.Util.convertToWebViewerRotationEnum(n.getPageRotation(e))),
                                (r.next = 7),
                                c.drawAnnotations(e, o)
                              );
                            case 7:
                              l(o);
                            case 8:
              ...
              console.error(t), h('Error occured while loading '.concat(document.filename, ' for page ').concat(e));
            }
            var v;
          }),
          cancel: function() {
      ...
      function g(n) {
        ...
        (e.width = e.maxX - e.minX), (e.height = e.maxY - e.minY);
        var o = { deltaX: e.minX < 0 ? -e.minX : e.minX, deltaY: e.minY < 0 ? -e.minY : e.minY },
          i = new t.Core.Math.TransformationBuilder();
        return (
          i.translate(o.deltaX, o.deltaY),
          (e.translate = i.getFinalTransform()),
          (e.points = [
            [e.minX, e.minY],
            [e.maxX, e.minY],
            [e.maxX, e.maxY],
      ...
      function m(n, e, o, i) {
        if (e) {
          var u = e.points.map(function(n) {
            ...
            f = window.turf.polygon([[].concat(r(c), [c[0]])]),
            s = window.turf.polygon([[].concat(r(o), [o[0]])]),

!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = r(c, v, 3), x = u(m.length), S = 0, w = e ? h(n, x) : a ? h(n, 0) : void 0; x > S; S++)
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Vt = function(t, n, e) {
          return !(Bt(t, (n = b(n, !0))) && w(e) && x(e, 'value')) || x(e, 'get') || x(e, 'set') || e.configurable || (x(e, 'writable') && !e.writable) || (x(e, 'enumerable') && !e.enumerable)
            ? U(t, n, e)
            : ((t[n] = e.value), t);
        };
      bt || ((V.f = Wt), (W.f = Vt)),
      ...
      v(Ut, Dt),
        h(Ut, yt, Dt.values),
        v(Ut, { slice: Lt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        jt(Ut, 'buffer', 'b'),
        jt(Ut, 'byteOffset', 'o'),
        jt(Ut, 'byteLength', 'l'),
        jt(Ut, 'length', 'e'),
          ...
          b
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(e)) {
                  if (!(e instanceof K || 'ArrayBuffer' == (a = S(e)) || 'SharedArrayBuffer' == a)) return xt in e ? Ft(v, e) : It.call(v, e);
                  (i = e), (p = Ot(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
      ...
      if (
        ...
        M ||
          (((b = n(function(n, e) {
            f(n, b, t);
            var r = v(new m(), n, b);
            return null != e && a(e, d, r[x], r), r;
          })).prototype = S),
          (S.constructor = b)),
          (P || A) && (_('delete'), _('has'), d && _('get')),
          (A || O) && _(x),
          g && S.clear && delete S.clear;
      } else (b = y.getConstructor(n, t, d, x)), u(b.prototype, e), (c.NEED = !0);
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      var m,
        ...
        M = P || S(y),
        A = y ? (_ ? S('entries') : M) : void 0,
        F = ('Array' == n && O.entries) || P;
      if (
        (F && (x = s(F.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), r || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : S('values'), keys: d ? M : S('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, e) {
    ...
    function U(t, n, e, r, o, i) {
      ...
      for (var c = t[F]._b, a = u + t[I], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var r,
      ...
      I = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(F) instanceof n && 0 !== P.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      q =
        ...
        s(function() {
          ...
          ? function(t, n, e) {
              var r = I(G, n);
              r && delete G[n], N(t, n, e), r && t !== G && N(G, n, r);
            }
          : N,
      K = function(t) {
      ...
      J = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          b(e),
          i(V, n) ? (e.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (e = O(e, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, e)) : N(t, n, e)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, e = T(w(t)), r = [], o = 0; e.length > o; ) i(V, (n = e[o++])) || n == C || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === G, r = T(e ? U : w(t)), o = [], u = 0; r.length > u; ) !i(V, (n = r[u++])) || (e && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === G && n.call(U, e), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, e));
            };
          return u && Y && q(G, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      R.prototype[D] || e(14)(R.prototype, D, R.prototype.valueOf),
      p(R, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), P = [], M = 1; M < b.length; M++) P.push(void 0 === (x = b[M]) ? x : String(x));
            var A = b.groups;
            if (h) {
              var F = [E].concat(P, O, p);
              void 0 !== A && F.push(A);
              var j = String(n.apply(void 0, F));
            } else j = y(E, p, O, P, A, n);
  ...
  function(t, n, e) {
    for (
      ...
      var d,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, p), x[l] || c(x, l, g), (a[g] = p), m)) for (d in r) x[d] || i(x, d, r[d], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
  ...
  function(t, n) {
    ...
    var p = void 0,
      ...
      g = new URLSearchParams(window.location.search).get('doc');
    g in d && (document.getElementById('samples-file-picker').value = g);
    var m = document.getElementById('samples-file-picker').value || 'SYH-letter';
    function b(t) {
      var n = (function t(n) {
        var e = { properties: {} };
        for (var r in n) {
          var o = n[r],
            i = {};
          switch (((e.properties[r] = i), (i.propertyOrder = o.docOrder), o.typeId)) {
            case 'TemplateSchemaBool':
              i.$ref = '#/definitions/template-bool';
              break;
            case 'TemplateSchemaContent':
              i.$ref = '#/definitions/template-content';
              break;
            case 'TemplateSchemaLoop':
              var u = new Set(o.loopType);
              (i.$ref = u.has('tableRow') && 1 === u.size ? '#/definitions/template-row-loop' : '#/definitions/template-loop'), (i.items = t(o.itemSchema)), (i.items.title = r);
          }
        }
        return e;
      })(t.keys);
      return (n.$ref = '#/definitions/template-schema'), (n.definitions = O), n;
    }
    function x(t) {
      var n = t.split('.'),
        e = [];
      if (n.length % 2 == 1) return '';
      for (var r = 1; r < n.length; r++) r % 2 == 1 && e.push(n[r]);
      return e.join('::');
    }
    function S() {
      var t,
        n = r(document.getElementsByClassName('autofill-initial-hidden'));
      try {
        for (n.s(); !(t = n.n()).done; ) {
          t.value.className = '';
        }
    ...
    function w() {
      document.getElementById('file-status').innerText = m.name || m;
    }
    function _(t) {
      ...
      if (t && 'object' == e(t))
        ...
        } else for (var u in t) 'image_url' === u ? ((n.href = t[u]), (t[u] = n.href)) : _(t[u]);
    }
    WebViewer({ path: '../../../lib', preloadWorker: 'office', fullAPI: !1 }, document.getElementById('viewer')).then(function(t) {
      var n = t.UI,
        e = t.Core,
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return w(), (n.next = 3), t.loadDocument(d[m] || m, { officeOptions: { doTemplatePrep: !0 } });
                  case 3:
                  case 'end':
                    return n.stop();
                }
              ...
              return regeneratorRuntime.wrap(function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      return (r = e.sent), (i = b(r)), (e.next = 6), P(t);
                    case 6:
                      (p && JSON.stringify(r) === JSON.stringify(h)) ||
                        ((h = r),
                        (u = {
                          theme: 'pdftron',
                          iconlib: 'pdftron',
                        ...
                        m in E && (u.startval = E[m]),
                        p && p.destroy(),
                        (p = new JSONEditor(document.getElementById('autofill-form'), u)),
                        (h = r),
                        p.on('ready', S),
                        p.on('ready', j),
                        p.on('addRow', j));
      ...
      var O = (function(t) {
        !(function(t, n) {
          ...
          (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && u(t, n);
        })(a, t);
        var n,
          e,
          r,
      ...
      function M() {
        return (M = l(
          regeneratorRuntime.mark(function t() {
            var i, u, c, a, f, s, l, p, h, d, g;
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      e.annotationManager.deleteAnnotations(v, !0),
                      (v = []),
                      (y = {}),
                  ...
                  case 7:
                        ...
                        try {
                          for (f.s(); !(s = f.n()).done; )
                            (l = s.value),
                              (p = l[0]),
                              (h = l[1]),
                              (d = new e.Math.Rect(h.x1 - 2, h.y1 - 2, h.x2 + 2, h.y2 + 2)),
                              (g = new e.Annotations.RectangleAnnotation()).setRect(d),
                              g.setPageNumber(p),
                              (g.FillColor = i),
                              (g.StrokeColor = u),
                              (g.StrokeThickness = 1),
                    ...
                    e.annotationManager.addAnnotations(v, !0), e.annotationManager.drawAnnotationsFromList(v);
                  case 11:
                  case 'end':
                    return t.stop();
                }
      ...
      function j() {
        for (var t = 0, n = ['je-checkbox', 'je-textarea', 'je-header', 'je-object__container']; t < n.length; t++) {
          var e,
            o = n[t],
            i = r(document.getElementsByClassName(o));
          try {
            for (i.s(); !(e = i.n()).done; ) {
              var u = e.value;
              if (u && 'true' !== u.getAttribute('has-annotation-listeners')) {
                u.setAttribute('has-annotation-listeners', 'true');
                var c = void 0,
                  a = void 0;
                if ('je-checkbox' === o) (c = u.parentNode.parentNode.parentNode), (a = u.parentNode.parentNode.parentNode);
                else if ('je-textarea' === o) (c = u.parentNode.parentNode.parentNode), (a = u.parentNode.parentNode.parentNode.parentNode.parentNode);
                else if ('je-header' === o) {
                  if (((c = u.parentNode), (a = u), 'array' !== c.getAttribute('data-schematype'))) continue;
                } else 'je-object__container' === o && ((c = u.parentNode.parentNode), (a = u.parentNode.parentNode));
                var f = c.getAttribute('data-schemapath');
                if (f) {
                  var s = x(f),
                    l = A.bind(null, s),
                    p = F.bind(null, s);
                  a.addEventListener('mouseenter', l), a.addEventListener('mouseleave', p);
                }
              }
            }
          } catch (t) {
      ...
      (document.getElementById('file-picker').onchange = function(t) {
        ...
        n && ((document.getElementById('samples-file-picker').selectedIndex = 0), (m = n), a());
      }),
        (document.getElementById('samples-file-picker').onchange = function(t) {
          (m = t.target.value), a();
        }),
        (document.getElementById('reset-document-button').onclick = a),
        (document.getElementById('generate-document-button').onclick = l(
          regeneratorRuntime.mark(function t() {
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
      ...
      O = {
        ...
        'template-image': {
          ...
          properties: {
            ...
            width: { type: 'integer', title: 'width (points)', propertyOrder: 2 },
            height: { type: 'integer', title: 'height (points)', propertyOrder: 3 },
          },
        },
        'template-content': {
          oneOf: [

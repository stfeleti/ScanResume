!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
  ...
  function(t, n) {
    ...
    var e = document.getElementById('flipbook'),
      o = document.getElementById('loading-message');
    o.innerHTML = 'Preparing document...';
    var i = { l: window.sampleL },
      u = new Core.DocumentViewer(),
      c = document.createElement('div');
    u.setViewerElement(c),
      u.setScrollViewElement(c),
      u.enableAnnotations(),
      u.addEventListener('annotationsLoaded', function() {
        var t = u.getDocument(),
          n = u.getAnnotationManager(),
          i = t.getPageInfo(1),
          c = i.width,
          f = i.height,
          a = t.getPageCount(),
          ...
          p = h.height,
          v = h.width;
        ((p * c) / f) * 2 < v ? (v = ((p * c) / f) * 2) : (p = ((v / c) * f) / 2);
        for (
          var y = function(e) {
              s.push(
                new Promise(function(i) {
                  var u = e + 1;
                  return t.requirePage(u).then(function() {
                    return t.loadCanvas({
                      pageNumber: u,
                      drawComplete:
                        ((e = regeneratorRuntime.mark(function t(r, e) {
                          return regeneratorRuntime.wrap(function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return l.push({ index: e, canvas: r }), (o.innerHTML = 'Loading page canvas... ('.concat(l.length, '/').concat(a, ')')), (t.next = 4), n.drawAnnotations(e, r);
                                case 4:
                                  i();
                                case 5:
                                case 'end':
        ...
        Promise.all(s).then(function() {
          e.removeChild(o),
            (e.style.margin = '60px 0px 0px auto'),
            l
              .sort(function(t, n) {
            ...
            $('#flipbook').turn({ width: v, height: p }),
            setTimeout(function() {
              $('#flipbook').turn('next');
            }, 500),
      ...
      u.loadDocument('https://pdftron.s3.amazonaws.com/downloads/pl/Cheetahs.pdf', i);
  },
]);
